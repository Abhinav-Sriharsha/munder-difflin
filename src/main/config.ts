...
export interface HarnessConfig {
  ...
  /** Legacy migration marker from the release that disabled scheduled compaction. */
  autoCompactDisabledMigrated?: boolean;
  /** One-time migration marker for upgrading persisted ops standups. */
  autoCompactEnabledMigrated?: boolean;
