...
After v0.5.0 goes stable we start maintaining a Pro version of Munder Difflin alongside the
community version. Community stays free, stays open, and keeps getting updates. Pro adds extra
features and integrations for power users and anyone who wants to take AI as far as it goes.
Everyone on the Founders' Wall gets their first year of Pro free.
...
<div class="stage">
  ...
  <section class="page p1">
    <div class="content">
      ...
      <h1>Thanks for building <span class="hl">while you do your thing.</span></h1>
      <p class="lede">If you have been running Munder Difflin for a while, this one is for you.
      You are not reading about agents that work on their own, <b>you already have a floor of
      them on your machine.</b> Most people are still waiting for this to show up. You are
      shipping with it. That puts you well ahead, and we are glad it is you.</p>

      <div class="two">
        <div class="card lilac">
          <span class="tag">Announcement</span>
          <h2>Munder Difflin Pro is coming.</h2>
          <p>After <b>v0.5.0</b> goes stable, we start maintaining a Pro version alongside the
          community one. <b>Community stays free, stays open, and keeps getting updates.</b>
          Pro adds extra features and integrations for power users, and for anyone who wants
          to take AI as far as it goes.</p>
        </div>
        <div class="band">
          <div class="yr">1<small>YEAR FREE</small></div>
          <div><b>On the Founders' Wall?</b>
          <span>Everyone on the wall gets their first year of Munder Difflin Pro on us. No
          code, no form. It is already yours.</span></div>
        </div>
      </div>
    </div>
    <div class="nav">
    ...
    <div class="content">
      ...
      <div class="meet">
        ...
        <div class="card sky">
          ...
          <h2>Come hang out.</h2>
          <p>Questions, floor screenshots, and a role when your PR lands.</p>
